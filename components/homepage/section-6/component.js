...
const Section6 = ({ configuration }) => {
  const onClickTab = useCallback(index => {
    const tabs = ['Climate change', 'Food security', 'Water quality'];
    logEvent('Homepage', 'click on "main benefits" buttons', tabs[index]);
  }, []);
          ...
          <div className="row mb-4">
            <div className="col-sm-12 col-md-8 offset-md-2 tab-content">
              ...
              <TabPanel>
                ...
                instability. But there are solutions, including maintaining or improving soil
                organic carbon stocks in terrestrial systems through sustainable land management.
              </TabPanel>
              <TabPanel>
                ...
                and reservoirs, biodegradation of pollutants and ultimately improvement in the
                quality of groundwater, rivers and oceans.
              </TabPanel>
            </div>
          </div>
        </Tabs>
