...
export const LAYERS = {
  'land-cover': {
    ...
    info: {
      ...
      citation:
        'European Space Agency Climate Change Initiative, Land Cover project. 2017. "300 M Annual Global Land Cover Time Series from 1992 to 2015." Retrieved from https://www.esa-landcover-cci.org/?q=node/175. Accessed through Resource Watch, (date). [www.resourcewatch.org](https://www.resourcewatch.org).',
  ...
  cropland: {
    ...
    info: {
      ...
      citation:
        'Ramankutty, N., A.T. Evan, C. Monfreda, and J.A. Foley (2008). "Farming the planet: 1. Geographic Distribution of global agricultural lands in the year 2000. Global Biogeochemical Cycles 22, Gb1003, doi:10.1029/2007/GB002952." Accessed through Resource Watch, (date). [www.resourcewatch.org](https://www.resourcewatch.org).',
  ...
  'wetlands-waterbodies': {
    ...
    info: {
      ...
      citation:
        'Lehner, B. and Döll, P. 2004. "Development and validation of a global database of lakes, reservoirs and wetlands." Journal of Hydrology 296/1-4: 1-22. Accessed through Resource Watch, (date). [www.resourcewatch.org](https://www.resourcewatch.org).',
      license: 'Restrictions apply',
  ...
  population: {
    ...
    info: {
      ...
      citation:
        'European Commission, Joint Research Centre (JRC); and Columbia University, Center for International Earth Science Information Network (CIESIN). 2015. "GHS Population Grid, Derived from GPW4, Multitemporal (1975, 1990, 2000, 2015)." Dataset. pid: http://data.europa.eu/89h/jrc-ghsl-ghs_pop_gpw4_globe_r2015a. Accessed through Resource Watch, (date). [www.resourcewatch.org](https://www.resourcewatch.org).',
      license: 'Attribution required',
  ...
  'erosion-risk': {
    ...
    info: {
      ...
      citation:
        'World Resources Institute. 2016. "Erosion." Global Forest Watch Water. Accessed through Resource Watch, (date). [www.resourcewatch.org](https://www.resourcewatch.org).',
      license: 'Creative Commons Attribution 4.0 International',
      licenseLink: 'https://creativecommons.org/licenses/by/4.0/',
    },
  },
